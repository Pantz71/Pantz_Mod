...
public class PMStats {
    ...
    public static final ResourceLocation INTERACT_WITH_FEEDING_TROUGH = PantzMod.location("interact_with_feeding_trough");
    ...
    public static void registerStats() {
        ...
        Registry.register(BuiltInRegistries.CUSTOM_STAT, INTERACT_WITH_FEEDING_TROUGH.getPath(), INTERACT_WITH_FEEDING_TROUGH);
        Stats.CUSTOM.get(INTERACT_WITH_FEEDING_TROUGH, StatFormatter.DEFAULT);
