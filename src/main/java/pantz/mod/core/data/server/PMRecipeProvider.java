...
import pantz.mod.core.other.PMConditionSerializers;
...
public class PMRecipeProvider extends BlueprintRecipeProvider {
    ...
    public PMRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
        super(PantzMod.MOD_ID, output, provider);
    }
    ...
    protected void buildRecipes(RecipeOutput output, HolderLookup.Provider holderLookup) {
        ...
        conditionalRecipe(output,
                ShapelessRecipeBuilder.shapeless(TOOLS, Items.FLINT_AND_STEEL)
                        ...
                        .unlockedBy(getHasName(Items.OBSIDIAN), has(Tags.Items.OBSIDIANS)),
                location("flint_and_steel"), FLINT_AND_STEEL);
        ...
        conditionalRecipe(output,
                ShapelessRecipeBuilder.shapeless(TOOLS, Items.FLINT_AND_STEEL)
                        ...
                        .requires(Items.FLINT)
                        .unlockedBy(getHasName(Items.FLINT), has(Items.FLINT))
                        .unlockedBy(getHasName(Items.OBSIDIAN), has(Tags.Items.OBSIDIANS)), new NotCondition(FLINT_AND_STEEL));
        ...
        conditionalRecipe(output,
                ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, Blocks.SPONGE)
                        ...
                        .pattern("/#/")
                        .pattern(" / ")
                        .unlockedBy("has_wool", has(ItemTags.WOOL)), CRAFTABLE_SPONGE);
        ...
        storageRecipesWithCustomPacking(output, MISC, STEEL_NUGGET.get(), MISC, PMItems.STEEL_INGOT.get(), "steel_ingot_from_nuggets", "steel_ingot");
        storageRecipesWithCustomUnpacking(output, MISC, PMItems.STEEL_INGOT.get(), BUILDING_BLOCKS, STEEL_BLOCK.get(), "steel_ingot_from_steel_block", "steel_ingot");

        doorBuilder(STEEL_DOOR.get(), Ingredient.of(PMItemTags.INGOTS_STEEL)).unlockedBy(getHasName(PMItems.STEEL_INGOT.get()), has(PMItemTags.INGOTS_STEEL)).save(output);
        trapdoorBuilder(STEEL_TRAPDOOR.get(), Ingredient.of(PMItemTags.INGOTS_STEEL)).unlockedBy(getHasName(PMItems.STEEL_INGOT.get()), has(PMItemTags.INGOTS_STEEL)).save(output);

        conditionalRecipe(output,
                ShapedRecipeBuilder.shaped(DECORATIONS, STEEL_BARS.get(), 16)
                        .define('#', PMItemTags.INGOTS_STEEL)
                        .pattern("###")
                        .pattern("###")
                        .unlockedBy(getHasName(PMItems.STEEL_INGOT.get()), has(PMItemTags.INGOTS_STEEL)), CAVERNS_AND_CHASMS);

        platedBricksRecipe(output, STEEL_BRICKS.get(), PMItemTags.INGOTS_STEEL, "steel");
        platedBricksRecipes(output, PMBlockFamilies.STEEL_BRICKS_FAMILY);
        ...
        ShapedRecipeBuilder.shaped(DECORATIONS, STEEL_CHAIN.get()).define('I', PMItemTags.INGOTS_STEEL).define('n', PMItemTags.NUGGETS_STEEL)
                ...
                .unlockedBy(getHasName(STEEL_NUGGET.get()), has(PMItemTags.NUGGETS_STEEL)).save(output);

        toolsAndArmor(output, STEEL_SWORD.get(), STEEL_SHOVEL.get(), STEEL_PICKAXE.get(), STEEL_AXE.get(), STEEL_HOE.get(), STEEL_HELMET.get(), STEEL_CHESTPLATE.get(), STEEL_LEGGINGS.get(), STEEL_BOOTS.get(), PMItems.STEEL_INGOT.get(), PMItemTags.INGOTS_STEEL);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(STEEL_PICKAXE.get(), STEEL_SHOVEL.get(), STEEL_AXE.get(), STEEL_HOE.get(), STEEL_SWORD.get(), STEEL_HELMET.get(), STEEL_CHESTPLATE.get(), STEEL_LEGGINGS.get(), STEEL_BOOTS.get(), STEEL_HORSE_ARMOR.get()), MISC, STEEL_NUGGET.get(), 0.1F, 200).unlockedBy("has_steel_pickaxe", has(STEEL_PICKAXE.get())).unlockedBy("has_steel_shovel", has(STEEL_SHOVEL.get())).unlockedBy("has_steel_axe", has(STEEL_AXE.get())).unlockedBy("has_steel_hoe", has(STEEL_HOE.get())).unlockedBy("has_steel_sword", has(STEEL_SWORD.get())).unlockedBy("has_steel_helmet", has(STEEL_HELMET.get())).unlockedBy("has_steel_chestplate", has(STEEL_CHESTPLATE.get())).unlockedBy("has_steel_leggings", has(STEEL_LEGGINGS.get())).unlockedBy("has_steel_boots", has(STEEL_BOOTS.get())).unlockedBy("has_steel_horse_armor", has(STEEL_HORSE_ARMOR.get())).save(output, location(getSmeltingRecipeName(STEEL_NUGGET.get())));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(STEEL_PICKAXE.get(), STEEL_SHOVEL.get(), STEEL_AXE.get(), STEEL_HOE.get(), STEEL_SWORD.get(), STEEL_HELMET.get(), STEEL_CHESTPLATE.get(), STEEL_LEGGINGS.get(), STEEL_BOOTS.get(), STEEL_HORSE_ARMOR.get()), MISC, STEEL_NUGGET.get(), 0.1F, 100).unlockedBy("has_steel_pickaxe", has(STEEL_PICKAXE.get())).unlockedBy("has_steel_shovel", has(STEEL_SHOVEL.get())).unlockedBy("has_steel_axe", has(STEEL_AXE.get())).unlockedBy("has_steel_hoe", has(STEEL_HOE.get())).unlockedBy("has_steel_sword", has(STEEL_SWORD.get())).unlockedBy("has_steel_helmet", has(STEEL_HELMET.get())).unlockedBy("has_steel_chestplate", has(STEEL_CHESTPLATE.get())).unlockedBy("has_steel_leggings", has(STEEL_LEGGINGS.get())).unlockedBy("has_steel_boots", has(STEEL_BOOTS.get())).unlockedBy("has_steel_horse_armor", has(STEEL_HORSE_ARMOR.get())).save(output, location(getBlastingRecipeName(STEEL_NUGGET.get())));
        // ----------------------

        // --- Sulfur ---
        polished(output, BUILDING_BLOCKS, POLISHED_SULFUR.get(), SULFUR.get());
        polished(output, BUILDING_BLOCKS, SULFUR_BRICKS.get(), POLISHED_SULFUR.get());
        storageRecipesWithCustomUnpacking(output, MISC, SULFUR_CRYSTAL.get(), BUILDING_BLOCKS, SULFUR_BLOCK.get(), "sulfur_shard_from_sulfur_block", "sulfur_crystal");
        ...
        ShapelessRecipeBuilder.shapeless(MISC, Items.GUNPOWDER, 2)
                ...
                .unlockedBy(getHasName(SULFUR_CRYSTAL.get()), has(PMItemTags.DUSTS_SULFUR)).save(output);

        conditionalRecipe(output, lampRecipe(SULFUR_LAMP.get(), PMItemTags.GEMS_SULFUR), CAVERNS_AND_CHASMS);
        generateRecipes(output, PMBlockFamilies.POLISHED_SULFUR_FAMILY);
        generateRecipes(output, PMBlockFamilies.SULFUR_BRICKS_FAMILY);

        stonecutterRecipes(output, PMBlockFamilies.POLISHED_SULFUR_FAMILY, SULFUR.get(), POLISHED_SULFUR.get());
        stonecutterRecipes(output, PMBlockFamilies.SULFUR_BRICKS_FAMILY, SULFUR.get(), POLISHED_SULFUR.get(), SULFUR_BRICKS.get());

        conversionRecipe(output, SULFUR_DUST.get(), SULFUR_CRYSTAL.get(), null, 2);
        oreRecipes(output, SULFUR_SMELTABLES, MISC, SULFUR_CRYSTAL.get(), 0.2f, 200, "sulfur");
        // ----------------------
        ...
        excavator(output, EXCAVATOR.get(), PMItems.STEEL_INGOT.get(), PMItemTags.INGOTS_STEEL);
        excavator(output, DIAMOND_EXCAVATOR.get(), Items.DIAMOND, Tags.Items.GEMS_DIAMOND);
        netheriteSmithingRecipe(output, DIAMOND_EXCAVATOR.get(), TOOLS, NETHERITE_EXCAVATOR.get());

        hammer(output, HAMMER.get(), PMItems.STEEL_INGOT.get(), PMItemTags.INGOTS_STEEL);
        hammer(output, DIAMOND_HAMMER.get(), Items.DIAMOND, Tags.Items.GEMS_DIAMOND);
        netheriteSmithingRecipe(output, DIAMOND_HAMMER.get(), TOOLS, NETHERITE_HAMMER.get());

        ShapelessRecipeBuilder.shapeless(TOOLS, DYNAMITE.get(), 3)
                .requires(Items.PAPER).requires(Ingredient.of(Tags.Items.GUNPOWDERS), 2)
        ...
        ShapelessRecipeBuilder.shapeless(TOOLS, FIERY_DYNAMITE.get(), 3)
                .requires(Items.PAPER).requires(Ingredient.of(Tags.Items.GUNPOWDERS), 3)
        ...
        ShapedRecipeBuilder.shaped(TOOLS, POTION_SATCHEL.get())
                .define('L', Tags.Items.LEATHERS).define('G', Tags.Items.INGOTS_GOLD)
        ...
        // --- Redstone ---
        ShapedRecipeBuilder.shaped(REDSTONE, ENDER_SCANNER.get())
                .define('O', Tags.Items.OBSIDIANS).define('R', Tags.Items.DUSTS_REDSTONE).define('E', Items.ENDER_EYE)
                .pattern("ORO")
                .pattern("RER")
                .pattern("ORO")
        ...
        ShapedRecipeBuilder.shaped(REDSTONE, REDSTONE_CONFIGURATOR.get())
        ...
        ShapedRecipeBuilder.shaped(REDSTONE, WEATHER_DETECTOR.get())
        ...
        conditionalRecipe(output,
                ShapedRecipeBuilder.shaped(TOOLS, ENTITY_FILTER.get())
                        ...
                        .pattern("#$#")
                        .pattern(" # ")
                        .unlockedBy(getHasName(Items.ROTTEN_FLESH), has(Items.ROTTEN_FLESH)), ENTITY_FILTERING);
        ...
        conditionalRecipe(output,
                ShapedRecipeBuilder.shaped(REDSTONE, ENTITY_DETECTOR.get())
                        ...
                        .pattern("777")
                        .pattern("___")
                        .unlockedBy(getHasName(Items.LAPIS_LAZULI), has(Tags.Items.GEMS_LAPIS)), new NotCondition(CAVERNS_AND_CHASMS));
        ...
        conditionalRecipe(output,
                ...
                location("entity_detector_from_silver_ingots"), CAVERNS_AND_CHASMS);
        ...
        colorBlockWithDye(output, dyes, lamps, REDSTONE, "redstone_lamps");
        ...
        conditionalRecipe(output,
                ShapedRecipeBuilder.shaped(REDSTONE, RANDOMIZER.get())
                        ...
                        .pattern("TQT")
                        .pattern("SSS")
                        .unlockedBy(getHasName(Items.REDSTONE_TORCH), has(Items.REDSTONE_TORCH)), new NotCondition(CAVERNS_AND_CHASMS));
        ...
        // --- Functional ---
        pedestalBuilder(STONE_PEDESTAL.get(), Blocks.STONE, Blocks.STONE_SLAB).save(output);
        pedestalBuilder(DEEPSLATE_PEDESTAL.get(), Blocks.POLISHED_DEEPSLATE, Blocks.POLISHED_DEEPSLATE_SLAB).save(output);
        pedestalBuilder(BLACKSTONE_PEDESTAL.get(), Blocks.POLISHED_BLACKSTONE, Blocks.POLISHED_BLACKSTONE_SLAB).save(output);
        pedestalBuilder(QUARTZ_PEDESTAL.get(), Ingredient.of(Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_PILLAR), Ingredient.of(Blocks.QUARTZ_SLAB)).unlockedBy(getHasName(Blocks.QUARTZ_PILLAR), has(Blocks.QUARTZ_PILLAR)).unlockedBy(getHasName(Blocks.QUARTZ_BLOCK), has(Blocks.QUARTZ_BLOCK)).save(output);
        pedestalBuilder(PRISMARINE_PEDESTAL.get(), Blocks.PRISMARINE, Blocks.PRISMARINE_SLAB).save(output);
        pedestalBuilder(PURPUR_PEDESTAL.get(), Blocks.PURPUR_BLOCK, Blocks.PURPUR_SLAB).save(output);
        ...
        ShapedRecipeBuilder.shaped(DECORATIONS, ROPE_LADDER.get())
                .define('/', Tags.Items.RODS_WOODEN).define('%', Tags.Items.STRINGS)
                .pattern("% %")
                .pattern("///")
                .pattern("% %")
        ...
        magicGlassBuilder(CHORUS_GLASS.get(), Blocks.CHORUS_FLOWER, BUILDING_BLOCKS).unlockedBy(getHasName(Blocks.CHORUS_PLANT), has(Blocks.CHORUS_PLANT)).save(output);
        magicGlassBuilder(SOUL_GLASS.get(), Blocks.SOUL_SAND, BUILDING_BLOCKS).unlockedBy(getHasName(Blocks.SOUL_SAND), has(Blocks.SOUL_SAND)).save(output);
        magicGlassBuilder(ECHO_GLASS.get(), Items.ECHO_SHARD, BUILDING_BLOCKS).unlockedBy(getHasName(Items.ECHO_SHARD), has(Items.ECHO_SHARD)).save(output);
        glassPaneBuilder(CHORUS_GLASS_PANE.get(), CHORUS_GLASS.get(), DECORATIONS).unlockedBy(getHasName(CHORUS_GLASS.get()), has(PMItemTags.GLASS_BLOCKS_CHORUS)).save(output);
        glassPaneBuilder(SOUL_GLASS_PANE.get(), SOUL_GLASS.get(), DECORATIONS).unlockedBy(getHasName(SOUL_GLASS.get()), has(PMItemTags.GLASS_BLOCKS_SOUL)).save(output);
        glassPaneBuilder(ECHO_GLASS_PANE.get(), ECHO_GLASS.get(), DECORATIONS).unlockedBy(getHasName(ECHO_GLASS.get()), has(PMItemTags.GLASS_BLOCKS_ECHO)).save(output);
        ...
        colorBlockWithDye(output, dyes, paperLanterns, DECORATIONS, "paper_lanterns");
        ...
        ShapedRecipeBuilder.shaped(DECORATIONS, ORNAMENT_LUCKY_COINS.get())
                .define('#', Items.PAPER).define('R', Items.RED_DYE)
                .define('S', Tags.Items.STRINGS).define('G', Tags.Items.INGOTS_GOLD)
                .pattern("#S#")
                .pattern("GRG")
                .pattern("#S#")
                .unlockedBy(getHasName(Items.PAPER), has(Items.PAPER))
        ...
        ShapedRecipeBuilder.shaped(DECORATIONS, SAFE.get())
                .define('I', PMItemTags.INGOTS_STEEL).define('O', Tags.Items.OBSIDIANS)
                .pattern("III")
                .pattern("O O")
                .pattern("III")
                .unlockedBy(getHasName(PMItems.STEEL_INGOT.get()), has(PMItemTags.INGOTS_STEEL))
        ...
        // --- Compressed ---
        storageRecipes(output, MISC, Items.LEATHER, BUILDING_BLOCKS, LEATHER_BLOCK.get());
        storageRecipes(output, MISC, Items.RABBIT_HIDE, BUILDING_BLOCKS, RABBIT_HIDE_BLOCK.get());
        storageRecipes(output, MISC, Items.PHANTOM_MEMBRANE, BUILDING_BLOCKS, PHANTOM_MEMBRANE_BLOCK.get());
        storageRecipes(output, MISC, Items.SUGAR_CANE, BUILDING_BLOCKS, SUGAR_CANE_BLOCK.get());
        storageRecipes(output, MISC, Items.FEATHER, BUILDING_BLOCKS, FEATHER_BLOCK.get());
        storageRecipes(output, MISC, Items.SUGAR, BUILDING_BLOCKS, SUGAR_BLOCK.get());
        storageRecipes(output, MISC, Items.BLAZE_POWDER, BUILDING_BLOCKS, FIERY_LAMP.get());

        // ----------------------
    }

    private static void logicGates(RecipeOutput output) {
        ...
        advancedLogicGate(AND_GATE.get(), ADVANCED_AND_GATE.get()).save(output);
        advancedLogicGate(NAND_GATE.get(), ADVANCED_NAND_GATE.get()).save(output);
        advancedLogicGate(OR_GATE.get(), ADVANCED_OR_GATE.get()).save(output);
        advancedLogicGate(NOR_GATE.get(), ADVANCED_NOR_GATE.get()).save(output);
        advancedLogicGate(XOR_GATE.get(), ADVANCED_XOR_GATE.get()).save(output);
        advancedLogicGate(XNOR_GATE.get(), ADVANCED_XNOR_GATE.get()).save(output);

    }

    public void platedBricksRecipe(RecipeOutput output, ItemLike block, TagKey<Item> ingotTag, String hasName) {
        conditionalRecipe(output, ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, block, 4).define('#', ingotTag).define('X', Blocks.DEEPSLATE).pattern("#X").pattern("X#").group(getItemName(block)).unlockedBy("has_" + hasName, has(ingotTag)), CAVERNS_AND_CHASMS);
    }

    public void platedBricksRecipes(RecipeOutput output, BlockFamily family) {
        generateRecipes(output, family);
        conditionalStonecutterRecipes(output, family, CAVERNS_AND_CHASMS);
    }

    public void stonecutterRecipes(RecipeOutput output, BlockFamily family, ItemLike... inputs) {
        for (ItemLike input : inputs) {
            ...
            if (family.getVariants().containsKey(BlockFamily.Variant.STAIRS)) {
                stonecutterRecipe(output, BUILDING_BLOCKS, family.get(BlockFamily.Variant.STAIRS), input);
            }

            if (family.getVariants().containsKey(BlockFamily.Variant.SLAB)) {
                stonecutterRecipe(output, BUILDING_BLOCKS, family.get(BlockFamily.Variant.SLAB), input, 2);
            }

            if (family.getVariants().containsKey(BlockFamily.Variant.WALL)) {
                stonecutterRecipe(output, DECORATIONS, family.get(BlockFamily.Variant.WALL), input);
            }

            if (family.getVariants().containsKey(BlockFamily.Variant.CHISELED)) {
                stonecutterRecipe(output, BUILDING_BLOCKS, family.get(BlockFamily.Variant.CHISELED), input);
            }
        }
    }

    public void conditionalStonecutterRecipes(RecipeOutput output, BlockFamily family, ICondition condition, ItemLike... inputs) {
        for (ItemLike input : inputs) {
            if (family.getBaseBlock().asItem() != input.asItem()) {
            ...
            if (family.getVariants().containsKey(BlockFamily.Variant.STAIRS)) {
                conditionalRecipe(output, stonecutterRecipe(BUILDING_BLOCKS, family.get(BlockFamily.Variant.STAIRS), input), ResourceLocation.parse(this.getModConversionRecipeName(family.get(BlockFamily.Variant.STAIRS), input) + "_stonecutting"), condition);
            }

            if (family.getVariants().containsKey(BlockFamily.Variant.SLAB)) {
                conditionalRecipe(output, stonecutterRecipe(BUILDING_BLOCKS, family.get(BlockFamily.Variant.SLAB), input, 2), ResourceLocation.parse(this.getModConversionRecipeName(family.get(BlockFamily.Variant.SLAB), input) + "_stonecutting"), condition);
            }

            if (family.getVariants().containsKey(BlockFamily.Variant.WALL)) {
                conditionalRecipe(output, stonecutterRecipe(DECORATIONS, family.get(BlockFamily.Variant.WALL), input), ResourceLocation.parse(this.getModConversionRecipeName(family.get(BlockFamily.Variant.WALL), input) + "_stonecutting"), condition);
            }

            if (family.getVariants().containsKey(BlockFamily.Variant.CHISELED)) {
                conditionalRecipe(output, stonecutterRecipe(DECORATIONS, family.get(BlockFamily.Variant.CHISELED), input), ResourceLocation.parse(this.getModConversionRecipeName(family.get(BlockFamily.Variant.CHISELED), input) + "_stonecutting"), condition);
            }
        }
    }
    ...
    public void oreRecipes(RecipeOutput consumer, List<ItemLike> inputs, RecipeCategory category, ItemLike output, float smeltingXp, int smeltingTime, String group) {
        oreRecipes(consumer, inputs, category, output, smeltingXp, smeltingTime, smeltingXp, smeltingTime / 2, group);
    }

    public void oreRecipes(RecipeOutput consumer, List<ItemLike> inputs, RecipeCategory category, ItemLike output, float smeltingXp, int smeltingTime, float blastingXp, int blastingTime, String group) {
    ...
    public static void hammer(RecipeOutput consumer, ItemLike result, ItemLike item, TagKey<Item> material) {
    ...
    public static void excavator(RecipeOutput consumer, ItemLike result, ItemLike item, TagKey<Item> material) {
    ...
    private static RecipeBuilder magicGlassBuilder(ItemLike glass, ItemLike ingredient, RecipeCategory category) {
        return ShapedRecipeBuilder.shaped(category, glass, 8).define('#', Tags.Items.GLASS_BLOCKS_COLORLESS).define('@', ingredient)
    ...
    private static void toolsAndArmor(RecipeOutput output, ItemLike sword, ItemLike shovel, ItemLike pickaxe, ItemLike axe, ItemLike hoe, ItemLike helmet, ItemLike chestplate, ItemLike leggings, ItemLike boots, ItemLike ingot, TagKey<Item> ingotTag) {
    ...
    public static void conditionalRecipe(RecipeOutput output, RecipeBuilder recipe, ResourceLocation location, ICondition... conditions) {
        recipe.save(output.withConditions(conditions), location);
    }
    
    protected void colorBlockWithDye(RecipeOutput consumer, List<Item> dyes, List<Item> dyeableItems, RecipeCategory category, String group) {
        for(int i = 0; i < dyes.size(); ++i) {
            ...
            ShapelessRecipeBuilder.shapeless(category, item1).requires(item)
                    ...
                    .group(group).unlockedBy("has_needed_dye", has(item)).save(consumer, ResourceLocation.fromNamespaceAndPath(this.getModID(), "dye_" + getItemName(item1)));
        }
    }

    public static ConfigValueCondition config(ConfigValue<?> value, String key, boolean inverted) {
        return new ConfigValueCondition(PMConditionSerializers.CONFIG.get(), value, key, Maps.newHashMap(), inverted);
    }

    public static ConfigValueCondition config(ConfigValue<?> value, String key) {
