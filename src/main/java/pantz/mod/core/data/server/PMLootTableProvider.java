    ...
    private static class PMBlockLoot extends BlockLootSubProvider {
        ...
        protected void generate() {
            ...
            for (RegistryObject<?> block : new RegistryObject[]{
                    ...
                    LOCK, UNIVERSAL_LOCK, SAFE, SPIKE, SPRINKLER, FEEDING_TROUGH,
                    LEATHER_BLOCK, RABBIT_HIDE_BLOCK, PHANTOM_MEMBRANE_BLOCK, SUGAR_CANE_BLOCK, SUGAR_BLOCK, FEATHER_BLOCK, FIERY_LAMP
            }) {
