...
public class SmallGlobeModel extends Model {
	private final ModelPart globe;

	public SmallGlobeModel(ModelPart root) {
	...
	public static LayerDefinition createModel() {
        ...
        globe.addOrReplaceChild("globe", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, (float) Math.PI, (float) Math.PI, 0.0F));
