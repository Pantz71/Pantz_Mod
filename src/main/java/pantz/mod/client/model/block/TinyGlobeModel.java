...
public class TinyGlobeModel extends Model {
	private final ModelPart globe;

	public TinyGlobeModel(ModelPart root) {
	...
	public static LayerDefinition createModel() {
        ...
        globe.addOrReplaceChild("globe", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, (float) Math.PI, (float) Math.PI, 0.0F));
