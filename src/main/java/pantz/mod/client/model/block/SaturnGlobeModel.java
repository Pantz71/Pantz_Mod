...
public class SaturnGlobeModel extends Model {
	private final ModelPart globe;

	public SaturnGlobeModel(ModelPart root) {
	...
	public static LayerDefinition createModel() {
        ...
        globe.addOrReplaceChild("ring", CubeListBuilder.create().texOffs(0, 24).addBox(-10.0F, 0.0F, -10.0F, 20.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.0F, 0.0F, 0.0F));
